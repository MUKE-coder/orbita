...
Everything still works — Orbita just takes a different path. See
[deploying your first app](/docs/quickstart#step-7--deploy-your-first-app) for the Docker image,
Compose, Dockerfile, and Nixpacks routes, and the [orbita.yaml spec](/docs/orbita-yaml) for how
the build path is chosen.
